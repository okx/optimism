...
use op_alloy_consensus::transaction::eip8130::lock_slot;
...
/// [`OpPooledTransaction`](crate::OpPooledTransaction)). No trait bounds
...
mod tests {
    ...
    type TestPool = Eip8130Pool<OpPooledTransaction>;
    ...
    fn make_tx(sender_byte: u8, nonce: u64, priority_fee: u128) -> OpPooledTransaction {
    ...
    fn tier_cache_expires() {
        ...
        let pool = Eip8130Pool::<OpPooledTransaction>::with_config(config);
    ...
    #[test]
    fn price_bump_math() {
        assert!(Eip8130Pool::<OpPooledTransaction>::meets_price_bump(100, 110, 10));
        assert!(!Eip8130Pool::<OpPooledTransaction>::meets_price_bump(100, 109, 10));
        assert!(Eip8130Pool::<OpPooledTransaction>::meets_price_bump(0, 0, 10));
        assert!(Eip8130Pool::<OpPooledTransaction>::meets_price_bump(0, 1, 10));
    }
