use crate::{
    conditional::MaybeConditionalTransaction, eip8130_invalidation::InvalidationKey,
...
where
    Cons: SignedTransaction + From<Pooled> + op_alloy_consensus::OpEip8130Transaction,
    Pooled: SignedTransaction + TryFrom<Cons>,
    <Pooled as TryFrom<Cons>>::Error: core::error::Error,
{
    fn encoded_2718(&self) -> Cow<'_, Bytes> {
