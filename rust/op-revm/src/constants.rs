...
// ---------------------------------------------------------------------------
// EIP-8130 owner scope bitmask (mirrors op_alloy_consensus::OwnerScope)
// ---------------------------------------------------------------------------
...
///
/// Mirrors `op_alloy_consensus::MAX_CALLS_PER_TX` and is enforced again at
...
///
/// Mirrors `op_alloy_consensus::MAX_ACCOUNT_CHANGES_PER_TX`.
