...
pub struct Eip8130Parts {
    ...
    /// Maximum gas for custom verifier STATICCALLs.
    pub custom_verifier_gas_cap: u64,
    /// The sender's verifier address.
    pub sender_verifier: Address,
    /// The payer's verifier address (`Address::ZERO` for self-pay).
    ...
    /// Pre-encoded STATICCALL for custom sender verifier.
    pub sender_verify_call: Option<Eip8130VerifyCall>,
    /// Pre-encoded STATICCALL for custom payer verifier.
