...
pub enum OpReceipt<T = Log> {
    ...
    ///
    /// Carries the same RLP shape as the 1559/7702 arms. AA-specific
    /// phase statuses travel in the log list (system log at
    /// `TX_CONTEXT_ADDRESS`), not in a new receipt field.
...
pub(crate) mod serde_bincode_compat {
    ...
    pub enum OpReceipt<'a> {
        ...
        /// EIP-8130 AA receipt (shape-identical to 1559/7702).
