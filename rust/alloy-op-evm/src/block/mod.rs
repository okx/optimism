    ...
    Spec: OpHardforks,
{
    ...
    fn execute_transaction_without_commit(
        ...
        // tx env; `OpEvm::transact_raw` disables base-fee validation for that single tx so the
        // zero-priced gasless tx clears validation without changing the opcode-visible base fee.
