...
contract CrossChainERC20_Test is Test {
    ...
    function setupL1Contracts() internal {
        ...
        l1StandardBridge = IL1StandardBridge(payable(vm.parseAddress("0x3056895664946eac2bc59f684c0712f61501c200")));
        l1CrossDomainMessenger = IL1CrossDomainMessenger(vm.parseAddress("0x71cbb610b78e79ad11132be423769a6effad3a4a"));
