...
/// @custom:upgradeable
/// @title StandardBridgeNew
/// @notice StandardBridgeNew is a base contract for the L1 and L2 standard ERC20 bridges. It handles
///         the core bridging logic, including escrowing tokens that are native to the local chain
///         and minting/burning tokens that are native to the remote chain.
abstract contract StandardBridgeNew is Initializable {
    ...
    /// @custom:network-specific
    StandardBridgeNew public otherBridge;
    ...
    function __StandardBridge_init(
        ...
        StandardBridgeNew _otherBridge
    )
        internal
        onlyInitializing
    {
    ...
    /// @custom:legacy
    function OTHER_BRIDGE() external view returns (StandardBridgeNew) {
        return otherBridge;
    }
