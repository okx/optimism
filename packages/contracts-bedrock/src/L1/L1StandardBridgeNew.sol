...
import {StandardBridgeNew} from "../universal/StandardBridgeNew.sol";

/// @custom:proxied true
/// @title L1StandardBridgeNew
/// @notice The L1StandardBridgeNew is responsible for transfering ETH and ERC20 tokens between L1 and
...
contract L1StandardBridgeNew is StandardBridgeNew, ProxyAdminOwnedBase, ReinitializableBase, ISemver {
    /// @custom:legacy
    ...
    constructor() StandardBridgeNew() ReinitializableBase(3) {
        ...
        reinitializer(initVersion())
    {
        ...
        __StandardBridge_init({
            ...
            _otherBridge: StandardBridgeNew(payable(Predeploys.L2_STANDARD_BRIDGE))
        });
    }

    /// @inheritdoc StandardBridgeNew
