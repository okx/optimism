...
contract L2StandardBridgeNew is StandardBridgeNew, ISemver {
    /// @custom:legacy
    ...
    constructor() StandardBridgeNew() {
        _disableInitializers();
    }

    /// @notice Initializer.
    /// @param _otherBridge Contract for the corresponding bridge on the other chain.
    function initialize(StandardBridgeNew _otherBridge) external initializer {
