...
// Modified by OP Labs and X-Layer.

pragma solidity 0.8.15;

/// @title WETH99
/// @notice WETH99 is a version of WETH9 upgraded for Solidity 0.8.x.
...
contract WETH99 {
    ...
    function transfer(address dst, uint256 wad) external virtual returns (bool) {
