...
contract UpgradeSystemConfig is Script {
    ...
    function _loadConfiguration() internal {
        ...
        opcmAddress = vm.envAddress(OPCM);
    ...
    function _validateConfiguration() internal view {
        ...
        require(opcmAddress != address(0), "OPCM address cannot be zero");
    ...
    function _readCurrentParameters() internal view returns (SystemConfigParams memory params) {
        ...
        // Read system contract addresses individually (old version may not have delayedWETH/opcm fields)
        params.addresses = SystemConfig.Addresses({
            ...
            delayedWETH: delayedWETHAddress,
            opcm: opcmAddress
        });
    ...
    function _logCurrentParameters(SystemConfigParams memory params) internal pure {
        ...
        console.log("DelayedWETH:", params.addresses.delayedWETH);
        console.log("OPCM:", params.addresses.opcm);
    ...
    function _verifyUpgradeAndReinit(SystemConfig upgradedSystemConfig, SystemConfigParams memory expectedParams) internal view {
        ...
        require(keccak256(bytes(newVersion)) == keccak256(bytes("3.14.0")), "Version not updated correctly");
        require(upgradedSystemConfig.initVersion() == 5, "initVersion not correct");
        ...
        require(newAddresses.opcm == expectedParams.addresses.opcm, "OPCM not set correctly");

        console.log("DelayedWETH:", newAddresses.delayedWETH);
        console.log("OPCM:", newAddresses.opcm);
        ...
        console.log("DelayedWETH and OPCM fields successfully set in SystemConfig");
