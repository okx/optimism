...
import (
	...
	"github.com/ethereum-optimism/optimism/op-proposer/mock"
	"github.com/stretchr/testify/require"
)

func TestTeeRollupServer_Basic(t *testing.T) {
	srv := mock.NewTeeRollupServer(t)
	...
	var body mock.TeeRollupResponse
	...
	var body2 mock.TeeRollupResponse
	...
	appHash := mock.ComputeAppHash(body2.Data.Height)
	require.Equal(t, "0x"+hex.EncodeToString(appHash[:]), body2.Data.AppHash)
	blockHash := mock.ComputeBlockHash(appHash)
