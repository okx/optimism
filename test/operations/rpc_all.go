...
func DebugTraceBlockByHash(blockHash common.Hash) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "debug_traceBlockByHash", blockHash, map[string]interface{}{})
	if err != nil {
		return nil, err
	}
...
func DebugTraceBlockByNumber(blockNumber uint64) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "debug_traceBlockByNumber", blockNumberHex, map[string]interface{}{})
	if err != nil {
		return nil, err
	}
...
func DebugTraceBatchByNumber(batchNumber uint64) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "debug_traceBatchByNumber", batchNumberHex, map[string]interface{}{})
	if err != nil {
		return nil, err
	}
...
func DebugTraceTransaction(txHash common.Hash) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "debug_traceTransaction", txHash, map[string]interface{}{})
	if err != nil {
		return nil, err
	}
...
func EthChainID() (uint64, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_chainId")
	if err != nil {
		return 0, err
	}
...
func EthEstimateGas(from, to common.Address, gas string, gasPrice string, value string, data string) (uint64, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_estimateGas", txParams)
	if err != nil {
		return 0, err
	}
...
func EthGetBalance(address common.Address, block string) (*big.Int, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getBalance", address, block)
	if err != nil {
		return nil, err
	}
...
func EthGetBlockByHash(blockHash common.Hash, fullTx bool) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getBlockByHash", blockHash, fullTx)
	if err != nil {
		return nil, err
	}
...
func EthGetBlockByNumber(blockNumber string, fullTx bool) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getBlockByNumber", blockNumber, fullTx)
	if err != nil {
		return nil, err
	}
...
func EthGetBlockTransactionCountByHash(blockHash common.Hash) (uint64, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getBlockTransactionCountByHash", blockHash)
	if err != nil {
		return 0, err
	}
...
func EthGetBlockTransactionCountByNumber(blockNumber string) (uint64, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getBlockTransactionCountByNumber", blockNumber)
	if err != nil {
		return 0, err
	}
...
func EthGetCode(address common.Address, block string) (string, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getCode", address, block)
	if err != nil {
		return "", err
	}
...
func EthGetTransactionCount(address common.Address, block string) (uint64, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getTransactionCount", address, block)
	if err != nil {
		return 0, err
	}
...
func TxPoolContent() (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "txpool_content")
	if err != nil {
		return nil, err
	}
...
func TxPoolStatus() (map[string]any, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "txpool_status")
	if err != nil {
		return nil, err
	}
...
func RemoveTransaction(networkUrl string, txHash common.Hash) error {
	...
	err := clientRPC.CallContext(ctx, &result, "txpool_removeTransaction", txHash)
	if err != nil {
		return err
	}
...
func EthCall(from, to common.Address, gas string, gasPrice string, value string, data string, block string) (string, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_call", txParams, block)
	if err != nil {
		return "", err
	}
...
func EthGetLogs(fromBlock, toBlock string, address common.Address) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getLogs", filter)
	if err != nil {
		return nil, err
	}
...
func EthGetStorageAt(address common.Address, position string, block string) (string, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getStorageAt", address, position, block)
	if err != nil {
		return "", err
	}
...
func EthGetTransactionByBlockHashAndIndex(blockHash common.Hash, index string) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getTransactionByBlockHashAndIndex", blockHash, index)
	if err != nil {
		return nil, err
	}
...
func EthGetTransactionByBlockNumberAndIndex(blockNumber string, index string) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getTransactionByBlockNumberAndIndex", blockNumber, index)
	if err != nil {
		return nil, err
	}
...
func EthGetTransactionByHash(txHash common.Hash) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getTransactionByHash", txHash)
	if err != nil {
		return nil, err
	}
...
func EthGetInternalTransactions(txHash common.Hash) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getInternalTransactions", txHash)
	if err != nil {
		return nil, err
	}
...
func EthGetBlockInternalTransactions(blockNumber string) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getBlockInternalTransactions", blockNumber)
	if err != nil {
		return nil, err
	}
...
func EthGetTransactionReceipt(txHash common.Hash) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "eth_getTransactionReceipt", txHash)
	if err != nil {
		return nil, err
	}
...
func TxPoolLimbo() (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "txpool_limbo")
	if err != nil {
		return nil, err
	}
...
func SyncGetOffChainData(hash common.Hash) (interface{}, error) {
	...
	err := clientRPC.CallContext(ctx, &result, "sync_getOffChainData", hash)
	if err != nil {
		return nil, err
	}
