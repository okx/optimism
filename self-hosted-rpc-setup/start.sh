...
echo "|---------|------|----------|---------|"
echo "| op-geth RPC | 8124 | HTTP | JSON-RPC API |"
echo "| op-geth WebSocket | 8546 | WebSocket | WebSocket API |"
echo "| op-node RPC | 9555 | HTTP | Consensus layer API |"
echo "| op-geth P2P | 30304 | TCP/UDP | P2P network |"
